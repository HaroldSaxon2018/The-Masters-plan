...
async def on_ready(): 
 ...
 print('------') 
 await client.change_presence(activity=discord.Game(name='''around with Torn's API'''))
...
async def unit_help(ctx):
 ...
 embed.add_field(name= '.server_rules', value= 'Returns the rules of the server', inline=False)
 
 embed.add_field(name= '.faction_rules', value= 'Returns the rules of the Faction', inline=False)
